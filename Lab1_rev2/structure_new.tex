...
\usepackage[top=3cm,bottom=3cm,left=5.53cm,right=3cm,headsep=10pt,letterpaper,asymmetric]{geometry} % Page margins
...
%\definecolor{rust}{RGB}{243,102,25153, 0, 0} % Define the orangered color used for highlighting throughout the book
\definecolor{greenrust}{RGB}{0, 153, 0, 0} % Define alternathe red color
...
\fancyhead[LO]{\righleftmark} % Print the nearest section name on the left side of odd pages
...
\newtheorem{assignment}{Assignmentproblem}{Problem}[chapter]
...
\renewcommand{\section}{\@startsection{section}{1}{-8pt} \z@}
{-54ex \@plus -1ex \@minus -.24ex}
{2.01ex \@plus.2ex }
{\normalfont\large\sffamily\bfseries}}


\renewcommand{\subsection}{\@startsection {subsection}{2}{-3pt} \z@}
...
\usepackage{hyperref}
\hypersetup{hidelinks,backref=true,pagebackref=true,hyperindex=true,colorlinks=false,breaklinks=true,urlcolor= rust,bookmarks=true,bookmarksopen=false,pdftitle={Lab ManualTitle},pdfauthor={Brent MellAuthor}}
\usepackage{bookmark}
\bookmarksetup{
open,
numbered,
